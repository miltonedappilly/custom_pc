      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-2.5 mb-5">
              <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-gradient-to-br from-blue-500 to-cyan-400">
                <Zap className="w-5 h-5 text-[#040610]" fill="currentColor" />
              </div>
            ...
            <p className="text-sm text-white/45 leading-relaxed mb-6 max-w-xs">
              Powering digital transformation across the Middle East & Africa with cutting-edge technology products and enterprise solutions.
            </p>
            <div className="flex items-center gap-3">
              {socials.map(({ label, href, icon }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 glass rounded-lg flex items-center justify-center text-white/40 hover:text-white hover:border-blue-500/40 border border-white/8 transition-all hover:scale-105"
                >
                  {icon}
                </a>
              ))}
        ...
        <div className="mt-14 pt-6 border-t border-white/6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/30">
            © {new Date().getFullYear()} Aztechmea. All rights reserved.
          </p>
